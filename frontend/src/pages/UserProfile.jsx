                        ...
                        <div className="text-center sm:text-left flex-1 flex flex-col justify-center">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                ...
                                <button
                                    ...
                                    className="bg-brand-pink text-white px-6 py-2.5 rounded-full font-bold shadow-md hover:bg-pink-600 hover:-translate-y-0.5 transition-all text-sm shrink-0 whitespace-nowrap"
                                >
                                    Manage Settings
                                </button>
                            </div>
                            ...
                            <div className="flex flex-wrap justify-center sm:justify-start gap-3 mt-2">
                                ...
                                <span className="bg-purple-50 text-purple-600 text-xs font-bold px-4 py-2 rounded-full shadow-sm border border-purple-100 capitalize">
                                    {user?.auth_provider === 'google' ? 'Google Account' : 'Member'}
                                </span>
                                {user?.age && (
